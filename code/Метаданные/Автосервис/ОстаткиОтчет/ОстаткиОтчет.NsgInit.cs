...
namespace NSGAuto.Метаданные.Автосервис
{
    ...
    [NsgTypeName("NsgReportObject", Guid = "0504f6ef-e6f3-4909-a70d-8132d45b1eb2")]
    public partial class ОстаткиОтчет : NsgSoft.DataObjects.NsgReportObject
    {
        #region Данные
        ...
        /// </summary>
        protected ОстаткиОтчет(NsgObject obj)
            : base(obj)
        {
        }
        ...
        public static ОстаткиОтчет Новый()
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("0504f6ef-e6f3-4909-a70d-8132d45b1eb2"));
            if (obj == null)
                obj = new ОстаткиОтчет();
            return obj as ОстаткиОтчет;
        }
	...
	Идентификатор.Guid = NsgService.StringToGuid("0420e72a-90fc-4e10-96c7-760d2d1e181f");
	...
	Автоинкремент.Guid = NsgService.StringToGuid("93797aa4-3afb-48e4-b731-c50fad206223");
			...
			#region создание NSGAuto.Метаданные.Автосервис.ОстаткиОтчетФорма Форма
			{  
	...
	Форма.FormClassName = "NSGAuto.Метаданные.Автосервис.ОстаткиОтчетФорма";
	...
	Форма.GroupName = "";
	Форма.Guid = NsgService.StringToGuid("dd1728c1-ca0b-42a4-b660-02dfac83bd8a");
	
				if (!ObjectList.Contains("Форма"))
                    ObjectList.Add(Форма);
			}
			#endregion //создание NSGAuto.Метаданные.Автосервис.ОстаткиОтчетФорма Форма
	...
	Name = "ОстаткиОтчет";
	Visible = true;
	Guid = NsgService.StringToGuid("0504f6ef-e6f3-4909-a70d-8132d45b1eb2");
	DefaultSortingName = "";
	...
	TableName = "NSGA_report_OstatkiOtchet";
	...
	GroupName = "Автосервис";
        ...
        {
            return "Автосервис.ОстаткиОтчет";
        }
        ...
        private ОстаткиОтчет[] convertArray(NsgMultipleObject[] array)
        {
            ОстаткиОтчет[] res = new ОстаткиОтчет[array.Length];
            array.CopyTo(res, 0);
            return res;
        }
        ...
        public new virtual ОстаткиОтчет[] FindAll(NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual ОстаткиОтчет[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual ОстаткиОтчет[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, string inName, object inValue)
        {
        ...
        /// <param name="inValue">Значение для поиска. Условие поиска - полное совпадение.</param>
        /// <returns>Список найденных объектов.</returns>
        public new virtual ОстаткиОтчет[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgDataFixedFields inName,
            object inValue)
        {
            return convertArray(base.FindAll(ref count, row_start, sorting, inName, inValue));
        }
        ...
        public override NsgObject CloneObject
        {
            get
            {
                return new ОстаткиОтчет(this as NsgObject);
            }
        }
        ...
        public new class ColumnDescriptor : NsgSoft.Forms.NsgColumnDescriptor
        {
            public ColumnDescriptor()
                : base()
            {
                base.NSGType = typeof(ОстаткиОтчет);
            }
			...
			public new ОстаткиОтчет Value
            {
                get
                {
                    return (ОстаткиОтчет)base.Value;
                }
                set
                {
                    base.Value = value;
