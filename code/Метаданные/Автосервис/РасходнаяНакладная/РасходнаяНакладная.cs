    ...
    public partial class РасходнаяНакладная
    {
        ...
        protected override bool Handling()
        {
            ...
            foreach (var i in table)
            {
                ...
                продажи.Сумма = i.Цена;
                продажи.Прибыль = i.Сумма - i.Номенклатура.Цена * i.Количество;
                продажи.Рентабильность = (продажи.Прибыль) / (i.Номенклатура.Цена * i.Количество); // % прибыли
