...
namespace NSGAuto.Метаданные._SystemTables
{
    ...
    [NsgTypeName("NsgDataTable", Guid = "1bec57f4-19e2-4ed3-ad84-7e6a1d09fc85")]
    public partial class АвтосервисРасходнаяНакладнаяТаблица : NsgSoft.DataObjects.NsgDataTable
    {
        #region Данные
        ...
        /// Создание объекта
        /// </summary>
        protected АвтосервисРасходнаяНакладнаяТаблица()
            : base()
        {
        }
        ...
        /// </summary>
        protected АвтосервисРасходнаяНакладнаяТаблица(NsgObject obj)
            : base(obj)
        {
        }
        ...
        public static АвтосервисРасходнаяНакладнаяТаблица Новый()
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("1bec57f4-19e2-4ed3-ad84-7e6a1d09fc85"));
            if (obj == null)
                obj = new АвтосервисРасходнаяНакладнаяТаблица();
            return obj as АвтосервисРасходнаяНакладнаяТаблица;
        }
	...
	Идентификатор.Guid = NsgService.StringToGuid("d353ee28-aa84-496d-a163-b941aafb6034");
	...
	Автоинкремент.Guid = NsgService.StringToGuid("719a62c9-13f4-493c-9eab-ed6460633964");
	...
	Владелец.GroupName = "";
	Владелец.Guid = NsgService.StringToGuid("d0b01604-4abc-4b94-9da4-b7aa6fbb97a2");
	...
	НомерСтроки.Guid = NsgService.StringToGuid("7234e19a-3b71-4790-932e-e9ef5bcacd70");
	...
	Номенклатура.Guid = NsgService.StringToGuid("8d3cd8be-cebc-4f98-983b-fa48ec8b3987");
	...
	Цена.GroupName = "";
	Цена.Guid = NsgService.StringToGuid("5bc43cfe-3de6-464e-bb9a-31fa277d7725");
	...
	Сумма.GroupName = "";
	Сумма.Guid = NsgService.StringToGuid("5c59a60f-2394-493d-b448-959043df2417");
	...
	Количество.Guid = NsgService.StringToGuid("ca60e7f4-eb6a-4664-a3c4-e34284bfb329");
	...
	Visible = true;
	Guid = NsgService.StringToGuid("1bec57f4-19e2-4ed3-ad84-7e6a1d09fc85");
	DefaultSortingName = "";
	...
	TableName = "NSGA_tab_AvtoservisRaskh";
	...
	GroupName = "_SystemTables";
        ...
        {
            return "_SystemTables.АвтосервисРасходнаяНакладнаяТаблица";
        }
        ...
        [NsgReferentsFilterAttribute("Автосервис.РасходнаяНакладная")]
        ...
        /// </summary>
        public new АвтосервисРасходнаяНакладнаяТаблица.Строка NewRow()
        {
            return newRow(null) as АвтосервисРасходнаяНакладнаяТаблица.Строка;
        }
        ...
        /// </summary>
        public new АвтосервисРасходнаяНакладнаяТаблица.Строка GetRow(int rowNumber)
        {
            return base.GetRow(rowNumber) as АвтосервисРасходнаяНакладнаяТаблица.Строка;
        }
        ...
        public new АвтосервисРасходнаяНакладнаяТаблица.Строка FindRowByTag(object Tag)
        {
            return base.FindRowByTag(Tag) as АвтосервисРасходнаяНакладнаяТаблица.Строка;
        }
        ...
        /// <param name="compare">Критерии поиска.</param>
        /// <returns>Найденные строки.</returns>
        public new АвтосервисРасходнаяНакладнаяТаблица.Строка[] FindRowsByTag(object Tag)
        {
        ...
        /// <param name="compare">Критерии поиска.</param>
        /// <returns>Найденные строки.</returns>
        public new АвтосервисРасходнаяНакладнаяТаблица.Строка FindRow(NsgCompare compare)
        {
            return base.FindRow(compare) as АвтосервисРасходнаяНакладнаяТаблица.Строка;
        }
        ...
        /// <returns>Найденные строки.</returns>
        public new АвтосервисРасходнаяНакладнаяТаблица.Строка FindRow(string inName, object inValue)
        {
        ...
        /// <param name="compare">Критерии поиска.</param>
        /// <returns>Найденные строки.</returns>
        public new АвтосервисРасходнаяНакладнаяТаблица.Строка[] FindRows(NsgCompare compare)
        {
        ...
        /// <param name="inValue">Значение поля.</param>
        /// <returns>Найденные строки.</returns>
        public new АвтосервисРасходнаяНакладнаяТаблица.Строка[] FindRows(string inName, object inValue)
        {
        ...
        /// </summary>
        public  NsgVirtualCursor<АвтосервисРасходнаяНакладнаяТаблица> GetNewVirtualCursor()
        {
            return base.GetNewVirtualCursor<АвтосервисРасходнаяНакладнаяТаблица>();
        }

        /// <summary>
        /// Получить все строки таблицы с учетом наложенного фильтра. Для получения всех сьтрок без учета фильтра используется свойство AllRows
        /// </summary>
        public new АвтосервисРасходнаяНакладнаяТаблица.Строка[] Rows
        {
            get
            {
        ...
        /// </summary>
        public new АвтосервисРасходнаяНакладнаяТаблица.Строка[] AllRows
        {
            get
            {
        ...
        /// <returns>Найденные строки.</returns>
        public new АвтосервисРасходнаяНакладнаяТаблица.Строка GetRow(Guid inID)
        {
            return base.GetRow(inID) as АвтосервисРасходнаяНакладнаяТаблица.Строка;
        }
        #endregion
        ...
        private АвтосервисРасходнаяНакладнаяТаблица[] convertArray(NsgMultipleObject[] array)
        {
            АвтосервисРасходнаяНакладнаяТаблица[] res = new АвтосервисРасходнаяНакладнаяТаблица[array.Length];
            array.CopyTo(res, 0);
            return res;
        }
        ...
        public new virtual АвтосервисРасходнаяНакладнаяТаблица[] FindAll(NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual АвтосервисРасходнаяНакладнаяТаблица[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual АвтосервисРасходнаяНакладнаяТаблица[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, string inName, object inValue)
        {
        ...
        public override NsgObject CloneObject
        {
            get
            {
                return new АвтосервисРасходнаяНакладнаяТаблица(this as NsgObject);
            }
        }
        ...
        public new class ColumnDescriptor : NsgSoft.Forms.NsgColumnDescriptor
        {
            public ColumnDescriptor()
                : base()
            {
                base.NSGType = typeof(АвтосервисРасходнаяНакладнаяТаблица);
            }
			...
			public new АвтосервисРасходнаяНакладнаяТаблица Value
            {
                get
                {
                    return (АвтосервисРасходнаяНакладнаяТаблица)base.Value;
                }
                set
                {
                    base.Value = value;
