...
namespace NSGAuto.Метаданные._SystemTables
{
    ...
    [NsgTypeName("NsgDataTable", Guid = "9a8d8248-ce26-4b6e-b656-17df3e82ef7e")]
    public partial class АвтосервисОстаткиНакопления : NsgSoft.DataObjects.NsgDataTable
    {
        ...
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("9a8d8248-ce26-4b6e-b656-17df3e82ef7e"));
            if (obj == null)
	...
	Автоинкремент.Guid = NsgService.StringToGuid("14e57b91-3b70-4de0-969f-ea772371251b");
	...
	Visible = true;
	Guid = NsgService.StringToGuid("9a8d8248-ce26-4b6e-b656-17df3e82ef7e");
	DefaultSortingName = "";
	...
	TableName = "NSGA_tab_AvtoservisOstat1";
