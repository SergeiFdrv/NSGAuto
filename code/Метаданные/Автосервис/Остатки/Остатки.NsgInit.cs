...
namespace NSGAuto.Метаданные.Автосервис
{
    ...
    [NsgTypeName("NsgDataRegister", Guid = "72675c13-f9fe-4a3b-bdf8-23d67755892d")]
    public partial class Остатки : NsgSoft.DataObjects.NsgDataRegister
    {
        ...
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("72675c13-f9fe-4a3b-bdf8-23d67755892d"));
            if (obj == null)
                obj = new Остатки();
	...
	Идентификатор.Guid = NsgService.StringToGuid("a62d69a4-f4c2-4d01-9536-70aa639167cf");
	...
	Автоинкремент.Guid = NsgService.StringToGuid("bd42c5e3-a307-4e0a-9bf8-012bc73118d3");
	...
	Движения.GroupName = "";
	Движения.Guid = NsgService.StringToGuid("954981a4-310f-4e98-be8f-4153ed5a596e");
	...
	Накопления.Guid = NsgService.StringToGuid("261d4c4c-8d35-47f9-94b6-9798ee5bf085");
	...
	Накопления_1.Guid = NsgService.StringToGuid("215a9c24-f2f9-412a-a39b-578224988ca4");
	...
	Владелец.GroupName = "";
	Владелец.Guid = NsgService.StringToGuid("e2653439-2acf-43ab-833c-46daec0f3450");
	...
	ВидДвижения.Guid = NsgService.StringToGuid("ae3c4c14-2040-4603-b67a-484728c43194");
	...
	ДатаДокумента.Guid = NsgService.StringToGuid("eee3f626-4c4a-4216-bcb6-d6725c0991ee");
	...
	Активность.Guid = NsgService.StringToGuid("1c5ef8ff-5e37-4ddd-afe3-ec43943511a1");
	...
	Номенклатура.Guid = NsgService.StringToGuid("60f83600-6625-4c7e-837f-3b583d621e51");
	...
	Сумма.GroupName = "";
	Сумма.Guid = NsgService.StringToGuid("9508a34d-557c-4f35-934b-3f7353759109");
	...
	Количество.Guid = NsgService.StringToGuid("327d9102-ef03-45c7-9fa1-39572614a992");
	...
	Name = "Остатки";
	Visible = true;
	Guid = NsgService.StringToGuid("72675c13-f9fe-4a3b-bdf8-23d67755892d");
	DefaultSortingName = "";
