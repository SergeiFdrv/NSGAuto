...
namespace NSGAuto.Метаданные._SystemTables
{
    ...
    [NsgTypeName("NsgDataTable", Guid = "387f5f0c-5e39-42f3-8025-b226bdb81d53")]
    public partial class АвтосервисОстаткиНакопления_1 : NsgSoft.DataObjects.NsgDataTable
    {
        ...
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("387f5f0c-5e39-42f3-8025-b226bdb81d53"));
            if (obj == null)
	...
	Автоинкремент.Guid = NsgService.StringToGuid("6900edd9-118b-4d04-9cec-3a8acad6591f");
	...
	ДатаДокумента.Guid = NsgService.StringToGuid("fb3e6ecd-c5e9-42c3-ad7c-3b5220c50996");
	...
	Visible = true;
	Guid = NsgService.StringToGuid("387f5f0c-5e39-42f3-8025-b226bdb81d53");
	DefaultSortingName = "";
	...
	TableName = "NSGA_tab_AvtoservisOstat2";
