...

{
    ...
    public partial class РасходнаяНакладнаяПечатьФорма:NsgSoft.Forms.NsgReportForm
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(РасходнаяНакладнаяПечатьФорма));
            ...
            this.СуммаИтого.Creator = typeof(NsgSoft.Forms.NsgReportForm);
        ...
        "NsgSoft.CityGuide.Dll"};
            ...
            this.nsgReport1.ReportGuid = "45ea1fc25f1c4c0281d30f48867b8a1b";
