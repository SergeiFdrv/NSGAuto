...
namespace NSGAuto.Метаданные.Автосервис
{
    ...
    [NsgTypeName("NsgReportObject", Guid = "d470c607-5645-4ea9-a3ce-277355b9d3d4")]
    public partial class РасходнаяНакладнаяПечать : NsgSoft.DataObjects.NsgReportObject
    {
        #region Данные
        ...
        /// Создание объекта
        /// </summary>
        protected РасходнаяНакладнаяПечать()
            : base()
        {
        }
        ...
        /// </summary>
        protected РасходнаяНакладнаяПечать(NsgObject obj)
            : base(obj)
        {
        }
        ...
        public static РасходнаяНакладнаяПечать Новый()
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("d470c607-5645-4ea9-a3ce-277355b9d3d4"));
            if (obj == null)
                obj = new РасходнаяНакладнаяПечать();
            return obj as РасходнаяНакладнаяПечать;
        }
	...
	Идентификатор.Guid = NsgService.StringToGuid("dc219173-9b32-4f33-b0d3-07d869dbdd4d");
	...
	Автоинкремент.Guid = NsgService.StringToGuid("2e9c6486-1657-4e46-8b4e-91793bfea278");
			...
			#region создание NSGAuto.Метаданные.Автосервис.РасходнаяНакладнаяПечатьФорма Форма
			{  
	...
	Форма.FormClassName = "NSGAuto.Метаданные.Автосервис.РасходнаяНакладнаяПечатьФорма";
	...
	Форма.GroupName = "";
	Форма.Guid = NsgService.StringToGuid("914020af-31f1-4ffd-80fe-03dc3bbb5e1e");
	
				if (!ObjectList.Contains("Форма"))
                    ObjectList.Add(Форма);
			}
			#endregion //создание NSGAuto.Метаданные.Автосервис.РасходнаяНакладнаяПечатьФорма Форма
			

			#region заполнение полей класса
				//NsgReportObject
	IsLoadedFromDll = true;
	Name = "РасходнаяНакладнаяПечать";
	Visible = true;
	Guid = NsgService.StringToGuid("d470c607-5645-4ea9-a3ce-277355b9d3d4");
	DefaultSortingName = "";
	...
	TableName = "NSGA_report_RaskhodnajaN";
	...
	GroupName = "Автосервис";
        ...
        {
            return "Автосервис.РасходнаяНакладнаяПечать";
        }
        ...
        private РасходнаяНакладнаяПечать[] convertArray(NsgMultipleObject[] array)
        {
            РасходнаяНакладнаяПечать[] res = new РасходнаяНакладнаяПечать[array.Length];
            array.CopyTo(res, 0);
            return res;
        }
        ...
        public new virtual РасходнаяНакладнаяПечать[] FindAll(NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual РасходнаяНакладнаяПечать[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual РасходнаяНакладнаяПечать[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, string inName, object inValue)
        {
        ...
        /// <param name="inValue">Значение для поиска. Условие поиска - полное совпадение.</param>
        /// <returns>Список найденных объектов.</returns>
        public new virtual РасходнаяНакладнаяПечать[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgDataFixedFields inName,
            object inValue)
        {
            return convertArray(base.FindAll(ref count, row_start, sorting, inName, inValue));
        }
        ...
        public override NsgObject CloneObject
        {
            get
            {
                return new РасходнаяНакладнаяПечать(this as NsgObject);
            }
        }
        ...
        public new class ColumnDescriptor : NsgSoft.Forms.NsgColumnDescriptor
        {
            public ColumnDescriptor()
                : base()
            {
                base.NSGType = typeof(РасходнаяНакладнаяПечать);
            }
			...
			public new РасходнаяНакладнаяПечать Value
            {
                get
                {
                    return (РасходнаяНакладнаяПечать)base.Value;
                }
                set
                {
                    base.Value = value;
