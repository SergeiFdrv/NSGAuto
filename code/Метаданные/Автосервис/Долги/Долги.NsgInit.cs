...
namespace NSGAuto.Метаданные.Автосервис
{
    ...
    [NsgTypeName("NsgReportObject", Guid = "e2ee7468-6693-4925-9d91-fc1fcab2bd00")]
    public partial class Долги : NsgSoft.DataObjects.NsgReportObject
    {
        ...
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("e2ee7468-6693-4925-9d91-fc1fcab2bd00"));
            if (obj == null)
                obj = new Долги();
            return obj as Долги;
        }
	...
	Идентификатор.Guid = NsgService.StringToGuid("887a1b5e-d1d6-40bc-a156-27e83579428a");
	...
	Автоинкремент.Guid = NsgService.StringToGuid("21cc4d6f-c99f-4470-9502-d5dcb8094e7f");
			...
			#region создание NSGAuto.Метаданные.Автосервис.ДолгиФорма Форма
			{  
	...
	Форма.FormClassName = "NSGAuto.Метаданные.Автосервис.ДолгиФорма";
	...
	Форма.GroupName = "";
	Форма.Guid = NsgService.StringToGuid("d91463fd-bcbe-4205-a865-0b49a439f57a");
	
				if (!ObjectList.Contains("Форма"))
                    ObjectList.Add(Форма);
			}
			#endregion //создание NSGAuto.Метаданные.Автосервис.ДолгиФорма Форма
	...
	Name = "Долги";
	Visible = true;
	Guid = NsgService.StringToGuid("e2ee7468-6693-4925-9d91-fc1fcab2bd00");
	DefaultSortingName = "";
