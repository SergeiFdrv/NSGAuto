...
namespace NSGAuto.Метаданные.Автосервис
{
    ...
    [NsgTypeName("NsgReportObject", Guid = "caf5cea3-ce70-422a-b6c8-87d9b52fd7a9")]
    public partial class ПриходнаяНакладнаяПечать : NsgSoft.DataObjects.NsgReportObject
    {
        #region Данные
        ...
        /// Создание объекта
        /// </summary>
        protected ПриходнаяНакладнаяПечать()
            : base()
        {
        }
        ...
        /// </summary>
        protected ПриходнаяНакладнаяПечать(NsgObject obj)
            : base(obj)
        {
        }
        ...
        public static ПриходнаяНакладнаяПечать Новый()
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("caf5cea3-ce70-422a-b6c8-87d9b52fd7a9"));
            if (obj == null)
                obj = new ПриходнаяНакладнаяПечать();
            return obj as ПриходнаяНакладнаяПечать;
        }
	...
	Идентификатор.Guid = NsgService.StringToGuid("f77ebbb1-bd9d-4b72-afd7-0a2ecf169979");
	...
	Автоинкремент.Guid = NsgService.StringToGuid("8450cfec-2c08-4de6-b853-fc280f7c54a6");
			...
			#region создание NSGAuto.Метаданные.Автосервис.ПриходнаяНакладнаяПечатьФорма Форма
			{  
	...
	Форма.FormClassName = "NSGAuto.Метаданные.Автосервис.ПриходнаяНакладнаяПечатьФорма";
	...
	Форма.GroupName = "";
	Форма.Guid = NsgService.StringToGuid("605c1853-6210-461d-925e-b5b8e0aff83f");
	
				if (!ObjectList.Contains("Форма"))
                    ObjectList.Add(Форма);
			}
			#endregion //создание NSGAuto.Метаданные.Автосервис.ПриходнаяНакладнаяПечатьФорма Форма
			

			#region заполнение полей класса
				//NsgReportObject
	IsLoadedFromDll = true;
	Name = "ПриходнаяНакладнаяПечать";
	Visible = true;
	Guid = NsgService.StringToGuid("caf5cea3-ce70-422a-b6c8-87d9b52fd7a9");
	DefaultSortingName = "";
	...
	TableName = "NSGA_report_PrikhodnajaN";
	...
	GroupName = "Автосервис";
        ...
        {
            return "Автосервис.ПриходнаяНакладнаяПечать";
        }
        ...
        private ПриходнаяНакладнаяПечать[] convertArray(NsgMultipleObject[] array)
        {
            ПриходнаяНакладнаяПечать[] res = new ПриходнаяНакладнаяПечать[array.Length];
            array.CopyTo(res, 0);
            return res;
        }
        ...
        public new virtual ПриходнаяНакладнаяПечать[] FindAll(NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual ПриходнаяНакладнаяПечать[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual ПриходнаяНакладнаяПечать[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, string inName, object inValue)
        {
        ...
        /// <param name="inValue">Значение для поиска. Условие поиска - полное совпадение.</param>
        /// <returns>Список найденных объектов.</returns>
        public new virtual ПриходнаяНакладнаяПечать[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgDataFixedFields inName,
            object inValue)
        {
            return convertArray(base.FindAll(ref count, row_start, sorting, inName, inValue));
        }
        ...
        public override NsgObject CloneObject
        {
            get
            {
                return new ПриходнаяНакладнаяПечать(this as NsgObject);
            }
        }
        ...
        public new class ColumnDescriptor : NsgSoft.Forms.NsgColumnDescriptor
        {
            public ColumnDescriptor()
                : base()
            {
                base.NSGType = typeof(ПриходнаяНакладнаяПечать);
            }
			...
			public new ПриходнаяНакладнаяПечать Value
            {
                get
                {
                    return (ПриходнаяНакладнаяПечать)base.Value;
                }
                set
                {
                    base.Value = value;
