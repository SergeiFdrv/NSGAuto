...
namespace NSGAuto.Метаданные._SystemTables
{
    ...
    [NsgTypeName("NsgDataTable", Guid = "3caed3ec-3f33-4c8e-a50e-8483b68fa75b")]
    public partial class PeriodicTable : NsgSoft.DataObjects.NsgDataTable
    {
        ...
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("3caed3ec-3f33-4c8e-a50e-8483b68fa75b"));
            if (obj == null)
	...
	Идентификатор.Guid = NsgService.StringToGuid("dc65e76d-dea4-48be-be58-efa8eebf16fa");
	...
	Автоинкремент.Guid = NsgService.StringToGuid("7c3d1b4a-3a24-42dd-9632-fd6fd5ee76a8");
	...
	Владелец.GroupName = "";
	Владелец.Guid = NsgService.StringToGuid("577b0086-ea64-4846-8b94-89562cc7ffc5");
	...
	Дата.GroupName = "";
	Дата.Guid = NsgService.StringToGuid("d48d8d3e-ec54-4df9-893e-67f6140279cb");
	...
	Значение.GroupName = "";
	Значение.Guid = NsgService.StringToGuid("33d285c3-10ec-483c-bb39-c0f912b6ed0f");
	...
	Индекс.GroupName = "";
	Индекс.Guid = NsgService.StringToGuid("a7653dc3-eb3a-4608-928e-1a1a36498e70");
	...
	Name = "PeriodicTable";
	Visible = true;
	Guid = NsgService.StringToGuid("3caed3ec-3f33-4c8e-a50e-8483b68fa75b");
	DefaultSortingName = "";
