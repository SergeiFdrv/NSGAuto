...
namespace NSGAuto.Метаданные.Сервис
{
    ...
    [NsgTypeName("NsgReportObject", Guid = "5287fb9a-0a30-4e1a-ab79-da9518ff0882")]
    public partial class ИмпортДанных : NsgSoft.DataObjects.NsgReportObject
    {
        ...
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("5287fb9a-0a30-4e1a-ab79-da9518ff0882"));
            if (obj == null)
	...
	Идентификатор.Guid = NsgService.StringToGuid("31f9c9db-2a2f-4d2d-a56b-2ded7fae8857");
	...
	Автоинкремент.Guid = NsgService.StringToGuid("7ccb5bac-a730-4e34-8872-767207a57a99");
	...
	ФормаЭлемента.Guid = NsgService.StringToGuid("7d8f10b2-95c8-4cff-a73f-66202447aa1c");
	...
	Name = "ИмпортДанных";
	Visible = true;
	Guid = NsgService.StringToGuid("5287fb9a-0a30-4e1a-ab79-da9518ff0882");
	DefaultSortingName = "";
