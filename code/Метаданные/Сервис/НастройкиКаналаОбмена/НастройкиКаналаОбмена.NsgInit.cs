...
namespace NSGAuto.Метаданные.Сервис
{
    ...
    [NsgTypeName("NsgDataDictionary", Guid = "393ef1ef-bc09-4435-94a5-f0c2a693dbd6")]
    public partial class НастройкиКаналаОбмена : NsgSoft.DataObjects.NsgDataDictionary
    {
        ...
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("393ef1ef-bc09-4435-94a5-f0c2a693dbd6"));
            if (obj == null)
	...
	Идентификатор.Guid = NsgService.StringToGuid("5010f662-25b4-425b-b384-3b2fd79084eb");
	...
	Автоинкремент.Guid = NsgService.StringToGuid("a0dd12f5-0070-4ac3-93eb-cc8c95da193a");
	...
	ЭтоГруппа.GroupName = "";
	ЭтоГруппа.Guid = NsgService.StringToGuid("ff30364a-e829-4b1e-bdb7-cc5cf27f8767");
	...
	ИдентификаторРодителя.Guid = NsgService.StringToGuid("626ab7ba-2acb-4ae8-bc86-36e27fb8059c");
	...
	Уровень.GroupName = "";
	Уровень.Guid = NsgService.StringToGuid("a1b43d2a-e85c-4306-b4cc-220f46c8de15");
	...
	ПрефиксКода.Guid = NsgService.StringToGuid("17c2bc19-3b4a-4255-8d7b-ef280bd850d4");
	...
	НомерКода.GroupName = "";
	НомерКода.Guid = NsgService.StringToGuid("7ef02dc5-d0a6-410d-9a03-9c27af1a981f");
	...
	Код.GroupName = "";
	Код.Guid = NsgService.StringToGuid("32faddac-644c-46f9-b4cc-953117f3fe46");
	...
	СостояниеДокумента.Guid = NsgService.StringToGuid("0fa9d645-abf2-4ae3-aa4d-a2de177849e0");
	...
	БазаИсточник.Guid = NsgService.StringToGuid("e6ebc5ec-d6bd-4612-bc4e-b83087031d85");
	...
	БазаПолучатель.Guid = NsgService.StringToGuid("c2f6c721-0a9e-418b-a838-85cccc42c3fa");
	...
	ТипОбмена.GroupName = "";
	ТипОбмена.Guid = NsgService.StringToGuid("13a234ec-25b6-482d-b572-5123dd6fde7d");
	...
	ПараметрыОбмена.Guid = NsgService.StringToGuid("5b76d33c-9b7d-4e3e-a7a6-17bb73c4f5a0");
	...
	Visible = true;
	Guid = NsgService.StringToGuid("393ef1ef-bc09-4435-94a5-f0c2a693dbd6");
	DefaultSortingName = "";
