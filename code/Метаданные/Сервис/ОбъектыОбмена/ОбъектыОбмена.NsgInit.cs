...
namespace NSGAuto.Метаданные.Сервис
{
    ...
    [NsgTypeName("NsgDataDictionary", Guid = "23d97f95-8c2f-4b3b-b788-ece728901602")]
    public partial class ОбъектыОбмена : NsgSoft.DataObjects.NsgDataDictionary
    {
        ...
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("23d97f95-8c2f-4b3b-b788-ece728901602"));
            if (obj == null)
	...
	Идентификатор.Guid = NsgService.StringToGuid("2b5690f6-ed0f-4118-a3c8-de02a13ab285");
	...
	Автоинкремент.Guid = NsgService.StringToGuid("fdb68d9b-b783-4481-850d-794100aca823");
	...
	ЭтоГруппа.GroupName = "";
	ЭтоГруппа.Guid = NsgService.StringToGuid("4e8eac70-d2c3-4789-ac5c-7938fccf0714");
	...
	ИдентификаторРодителя.Guid = NsgService.StringToGuid("e66b0c46-14c4-4da7-bb64-651f9f0d769c");
	...
	Уровень.GroupName = "";
	Уровень.Guid = NsgService.StringToGuid("087649c2-a65b-43ba-94c9-6259de923eeb");
	...
	ПрефиксКода.Guid = NsgService.StringToGuid("92872a4b-4af1-49af-9db5-8d02ed96000b");
	...
	НомерКода.GroupName = "";
	НомерКода.Guid = NsgService.StringToGuid("37774e0d-0cc0-47a2-b0ea-cc35bccfc014");
	...
	Код.GroupName = "";
	Код.Guid = NsgService.StringToGuid("e59924e3-5635-4dd5-a5c9-02eb7f4b104c");
	...
	СостояниеДокумента.Guid = NsgService.StringToGuid("6872252a-70fd-49fa-bad5-051c4abb124a");
	...
	ОбъектОбмена.Guid = NsgService.StringToGuid("95d0174c-4d0b-402c-9686-5f4b28514fd9");
	...
	БазаПолучатель.Guid = NsgService.StringToGuid("13c857a6-f610-4dc4-b3c1-349cf8bfce5e");
	...
	НомерОбмена.Guid = NsgService.StringToGuid("0a473b7f-3a90-48ca-922d-843d880fe90e");
	...
	Name = "ОбъектыОбмена";
	Visible = true;
	Guid = NsgService.StringToGuid("23d97f95-8c2f-4b3b-b788-ece728901602");
	DefaultSortingName = "";
