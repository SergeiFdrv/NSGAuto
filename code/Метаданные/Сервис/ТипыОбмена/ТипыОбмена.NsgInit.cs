...
namespace NSGAuto.Метаданные.Сервис
{
    ...
    [NsgTypeName("NsgDataDictionary", Guid = "a6bb29f6-15df-45b0-b09a-6814f4048e78")]
    public partial class ТипыОбмена : NsgSoft.DataObjects.NsgDataDictionary
    {
        ...
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("a6bb29f6-15df-45b0-b09a-6814f4048e78"));
            if (obj == null)
                obj = new ТипыОбмена();
	...
	Идентификатор.Guid = NsgService.StringToGuid("06f028e0-44e4-42d8-9a85-01e5db054b02");
	...
	Автоинкремент.Guid = NsgService.StringToGuid("674c33d3-2f38-4f08-a68b-76f2bfec2981");
	...
	ЭтоГруппа.GroupName = "";
	ЭтоГруппа.Guid = NsgService.StringToGuid("4b22eda1-7b35-48b3-9a84-8a3ad534f908");
	...
	ИдентификаторРодителя.Guid = NsgService.StringToGuid("a8467f13-1003-408d-8447-270721a3a2b4");
	...
	Уровень.GroupName = "";
	Уровень.Guid = NsgService.StringToGuid("40a814b4-c0d4-4e37-8093-cf333cdc6627");
	...
	ПрефиксКода.Guid = NsgService.StringToGuid("9a2470e6-0cc0-4277-bb30-fd13fbd817b4");
	...
	НомерКода.GroupName = "";
	НомерКода.Guid = NsgService.StringToGuid("b5cf16a1-e433-4541-bf4b-6c77ac260ef5");
	...
	Код.GroupName = "";
	Код.Guid = NsgService.StringToGuid("543801fb-b4a4-4628-b921-d2fa080a48ca");
	...
	СостояниеДокумента.Guid = NsgService.StringToGuid("a5efa1a2-b6d2-4dac-a5eb-ec3b68119c12");
	...
	Наименование.Guid = NsgService.StringToGuid("1c1076eb-bf77-4dee-a607-9c0b698b8f2a");
	...
	Файл.Guid = NsgService.StringToGuid("7d8dd219-a4e7-47b2-9e0b-38bd6ca9ddae");
	...
	Email.Guid = NsgService.StringToGuid("da71b79e-bd28-451e-bd4b-0a98ec528ffc");
	...
	SQL.Guid = NsgService.StringToGuid("f8335587-1db5-4925-b4d6-e3be5b7ba4f1");
	...
	Name = "ТипыОбмена";
	Visible = true;
	Guid = NsgService.StringToGuid("a6bb29f6-15df-45b0-b09a-6814f4048e78");
	DefaultSortingName = "";
	...
	GroupName = "Сервис";
        ...
        public static ТипыОбмена Файл
        {
            get
            {
                return (ТипыОбмена)getPredefined(NsgService.StringToGuid("a6bb29f6-15df-45b0-b09a-6814f4048e78"), NsgService.StringToGuid("7d8dd219-a4e7-47b2-9e0b-38bd6ca9ddae"));
            }
        }
        ...
        public static ТипыОбмена Email
        {
            get
            {
                return (ТипыОбмена)getPredefined(NsgService.StringToGuid("a6bb29f6-15df-45b0-b09a-6814f4048e78"), NsgService.StringToGuid("da71b79e-bd28-451e-bd4b-0a98ec528ffc"));
            }
        }
        ...
        public static ТипыОбмена SQL
        {
            get
            {
                return (ТипыОбмена)getPredefined(NsgService.StringToGuid("a6bb29f6-15df-45b0-b09a-6814f4048e78"), NsgService.StringToGuid("f8335587-1db5-4925-b4d6-e3be5b7ba4f1"));
            }
        }
