...
namespace NSGAuto.Метаданные.Сервис
{
    ...
    [NsgTypeName("NsgDataAssemblyObject", Guid = "ad612a0f-8761-4d7b-bf33-a02b4352e9c8")]
    public partial class DataAssemblyObject : NsgSoft.DataObjects.NsgDataAssemblyObject
    {
        ...
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("ad612a0f-8761-4d7b-bf33-a02b4352e9c8"));
            if (obj == null)
	...
	Идентификатор.Guid = NsgService.StringToGuid("e41d37ed-0d25-4475-9133-fb68f4fef2d5");
	...
	Автоинкремент.Guid = NsgService.StringToGuid("6bfa0e65-2207-4d17-8c54-d44e6063555f");
	...
	ЭтоГруппа.GroupName = "";
	ЭтоГруппа.Guid = NsgService.StringToGuid("46f38af8-0bf3-49a1-b2ae-0fd4d572a3af");
	...
	ИдентификаторРодителя.Guid = NsgService.StringToGuid("e055419f-7a89-443d-98d5-5a6678cd1201");
	...
	Уровень.GroupName = "";
	Уровень.Guid = NsgService.StringToGuid("55235ee6-30b6-4f87-839d-37b2246c6273");
	...
	ПрефиксКода.Guid = NsgService.StringToGuid("a049eef4-e3ad-4751-84af-4c97eeeb235a");
	...
	НомерКода.GroupName = "";
	НомерКода.Guid = NsgService.StringToGuid("9a474da1-2c2a-4649-8f96-3bfcc320430f");
	...
	Код.GroupName = "";
	Код.Guid = NsgService.StringToGuid("9999eb2c-0a07-4ef4-834f-0c072af6e99b");
	...
	_AsmName.GroupName = "";
	_AsmName.Guid = NsgService.StringToGuid("705e5de5-09d8-4d08-85c7-ae9780c0d9f3");
	...
	_AsmVersion.Guid = NsgService.StringToGuid("759f89ff-3863-4b04-8b16-f77f74004029");
	...
	_AsmHash.GroupName = "";
	_AsmHash.Guid = NsgService.StringToGuid("ac2fdbf3-9233-4656-8091-a0d74d89d10a");
	...
	_AsmData.GroupName = "";
	_AsmData.Guid = NsgService.StringToGuid("836feb9d-06bf-4f21-a022-4e656336a116");
	...
	СостояниеДокумента.Guid = NsgService.StringToGuid("0ba0c1ef-f416-42f9-95b0-c3031258f1d7");
	...
	Visible = true;
	Guid = NsgService.StringToGuid("ad612a0f-8761-4d7b-bf33-a02b4352e9c8");
	DefaultSortingName = "";
