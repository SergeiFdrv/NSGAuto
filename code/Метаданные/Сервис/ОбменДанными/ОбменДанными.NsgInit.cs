...
namespace NSGAuto.Метаданные.Сервис
{
    ...
    [NsgTypeName("NsgReportObject", Guid = "8055b0d5-cb5f-4208-9648-c20d7eb41905")]
    public partial class ОбменДанными : NsgSoft.DataObjects.NsgReportObject
    {
        ...
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("8055b0d5-cb5f-4208-9648-c20d7eb41905"));
            if (obj == null)
	...
	Идентификатор.Guid = NsgService.StringToGuid("de4cdbf1-1b3c-4781-960d-19f4a40ff2ae");
	...
	Автоинкремент.Guid = NsgService.StringToGuid("dcac17e1-5497-410d-811f-5414b3583dfb");
	...
	ФормаЭлемента.Guid = NsgService.StringToGuid("c676cde3-e8ab-4828-86e8-2f7bdd837ded");
	...
	Name = "ОбменДанными";
	Visible = true;
	Guid = NsgService.StringToGuid("8055b0d5-cb5f-4208-9648-c20d7eb41905");
	DefaultSortingName = "";
