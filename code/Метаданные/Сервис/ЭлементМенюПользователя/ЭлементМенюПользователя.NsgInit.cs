...
namespace NSGAuto.Метаданные.Сервис
{
    ...
    [NsgTypeName("NsgDataDictionary", Guid = "f22d6f72-d99f-4ca5-ad28-bddac306eacf")]
    public partial class ЭлементМенюПользователя : NsgSoft.DataObjects.NsgDataDictionary
    {
        ...
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("f22d6f72-d99f-4ca5-ad28-bddac306eacf"));
            if (obj == null)
	...
	Идентификатор.Guid = NsgService.StringToGuid("7dd2f128-033a-46fc-8477-f878dcbf9c5f");
	...
	Автоинкремент.Guid = NsgService.StringToGuid("00a5e5e2-b7a9-4809-b3e6-da9198ccdc12");
	...
	ЭтоГруппа.GroupName = "";
	ЭтоГруппа.Guid = NsgService.StringToGuid("0905ec20-dba1-4a71-a5d8-a47370f244d2");
	...
	ИдентификаторРодителя.Guid = NsgService.StringToGuid("84e8d70d-69e5-4a8c-a570-ebd8f0f1f459");
	...
	Уровень.GroupName = "";
	Уровень.Guid = NsgService.StringToGuid("d82aa3d6-b5c6-4534-bc84-cc3ea7c0e3f8");
	...
	ПрефиксКода.Guid = NsgService.StringToGuid("a6b4f65e-1c2b-48a1-880b-91ec981739bd");
	...
	НомерКода.GroupName = "";
	НомерКода.Guid = NsgService.StringToGuid("aa74c1bf-29e4-49d1-8052-ce23b17a9326");
	...
	Код.GroupName = "";
	Код.Guid = NsgService.StringToGuid("f130b11f-c4c5-433f-85b7-114adf034952");
	...
	СостояниеДокумента.Guid = NsgService.StringToGuid("91d6c910-03dc-4c8c-8464-36171e878d75");
	...
	Наименование.Guid = NsgService.StringToGuid("fdc32236-e36b-4e59-b3fb-09c278b6aacc");
	...
	ОбъектМетаданных.Guid = NsgService.StringToGuid("b2d8949a-de41-45ea-adc6-9f988f8c7c7d");
	...
	Картинка.GroupName = "";
	Картинка.Guid = NsgService.StringToGuid("83810dae-10ae-41ff-84d6-97d425831c2a");
	...
	БольшаяИконка.Guid = NsgService.StringToGuid("ab1878cf-3b31-49d3-8a41-9b9fcce6717a");
	...
	Таблица.GroupName = "";
	Таблица.Guid = NsgService.StringToGuid("acd47200-fdfb-40b9-8d4c-d232abf747a5");
	...
	Visible = true;
	Guid = NsgService.StringToGuid("f22d6f72-d99f-4ca5-ad28-bddac306eacf");
	DefaultSortingName = "";
